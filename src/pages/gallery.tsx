            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
              {savedMemories.map(memory => (
                <div key={memory.id} className="ticket p-4 sm:p-5 flex flex-col">
                  ...
                  <div className="w-full aspect-[3/4] bg-black/10 rounded-2xl overflow-hidden mb-4 relative flex items-center justify-center p-3 shadow-inner border border-black/10">
                    <img 
                      src={memory.url} 
