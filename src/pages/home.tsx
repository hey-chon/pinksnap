...
const STEPS = [
  {
    ...
    desc: 'Sign up or log in, then grant PinkSnap camera permission when your browser asks. Nothing is uploaded — your photos stay on your device only! 🔒',
    tags: [
      { text: '✓ 100% Private', cls: 'bg-green-50 text-green-700 border-green-100' },
      { text: 'Browser Prompt', cls: 'bg-primary/8 text-primary border-primary/15' },
    ],
  },
  {
    num: 2,
    label: 'PICK A STYLE',
    img: '/ss-setup.jpg',
    imgAlt: 'PinkSnap setup page — choose layout and frame',
    icon: <LayoutGrid className="w-5 h-5" />,
    desc: 'Pick your layout (classic strip, quad grid, wide duo…) and choose a themed frame — Minimal, Birthday, Aesthetic, and more!',
    tags: [
  ...
  },
  {
    ...
    label: 'STRIKE A POSE',
    img: '/ss-studio.jpg',
    imgAlt: 'PinkSnap studio — live camera with countdown timer',
    icon: <Wand2 className="w-5 h-5" />,
    desc: 'Watch the 3-second countdown and get ready! PinkSnap auto-captures 3–4 photos. Smile, silly faces, anything goes! 📸',
    tags: [
  ...
  },
  {
    ...
    label: 'SAVE & SHARE',
    img: '/ss-edit.jpg',
    imgAlt: 'PinkSnap edit page — customize and download your strip',
    icon: <Download className="w-5 h-5" />,
    desc: 'Edit your strip — apply filters, adjust the frame, add stickers — then download to your device or save to your PinkSnap gallery. Your memories, your way!',
    tags: [
      { text: '↓ Download', cls: 'bg-green-50 text-green-700 border-green-100' },
      { text: 'Edit First', cls: 'bg-primary/8 text-primary border-primary/15' },
